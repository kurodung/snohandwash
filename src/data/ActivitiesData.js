...
export const basicDoc = [
  ...
  'ซักประวัติ',
  'สัมผัสตัวผู้ป่วย',
  'สัมผัสอุปกรณ์ที่สอดใส่เข้าไปในร่างกาย เช่น ET tube, IV, foley, ทำหัตถการต่างๆ',
...
export const Cleanerafter = [
  'off IV',
  'ช่วยเปลี่ยนอุปกรณ์เครื่องช่วยหายใจ',
  'พ่นยา',
  'ให้อาหารทางสายยาง',
  'ช่วยทำแผล',
  'ถอดสายสวนปัสสาวะ',
...
export const activitiesByStatusAndMoment = {
    ...
    'นักศึกษาพยาบาล': {
      'Moment 1 ก่อนสัมผัสผู้ป่วย': basicNurse,
      'Moment 2 ก่อนทำกิจกรรมสะอาด ปราศจากเชื้อ': ['เตรียมยาฉีด',...internNurse,'จัดเตรียม set sterile'],
      'Moment 3 หลังสัมผัสเลือด สารคัดหลั่ง': [...AssNurseActiviti,'เทปัสสาวะ','เก็บ set ต่างๆ', 'ล้างทำความสะอาดอุปกรณ์','เก็บรวบรวมผ้าเปื้อน'],
      'Moment 4 หลังสัมผัสผู้ป่วย': basicNurse,
      'Moment 5 หลังสัมผัสสิ่งแวดล้อมผู้ป่วย': [...aftertouch,'เก็บรวบรวมผ้าเปื้อน','ทำความสะอาดสิ่งแวดล้อม']
    },
    ...
    'พนักงานทำความสะอาด': {
      'Moment 1 ก่อนสัมผัสผู้ป่วย': basicAssNurse.filter(a => a !== 'ตรวจเยี่ยมผู้ป่วย'),
      'Moment 2 ก่อนทำกิจกรรมสะอาด ปราศจากเชื้อ': Cleaner,
      'Moment 3 หลังสัมผัสเลือด สารคัดหลั่ง': ["ช่วยดูดเสมหะ",...Cleanerafter,'เทปัสสาวะ','เก็บ set ต่างๆ', 'ล้างทำความสะอาดอุปกรณ์','เก็บรวบรวมผ้าเปื้อน'],
      'Moment 4 หลังสัมผัสผู้ป่วย': basicAssNurse.filter(a => a !== 'ตรวจเยี่ยมผู้ป่วย'),
      'Moment 5 หลังสัมผัสสิ่งแวดล้อมผู้ป่วย': [...aftertouch,'เก็บรวบรวมผ้าเปื้อน','ทำความสะอาดสิ่งแวดล้อม']
    },
